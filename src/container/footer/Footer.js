        ...
        <Container fluid>
          ...
          <Row className="mt-5">
            ...
            >
              ...
              AIZZA COLLEGE <br /> OF ENGINEERING AND TECHNOLOGY 
              </h4>
            </Col>
            <Col
              sm={6}
              ...
              >
                <p class="d-flex flex-wrap">
                  ...
                  <span>Mulkalla,
                      ...
                      Adilabad,
                      MANCHERIAL,
                      Mancherial, 504209</span>
                </p>
                <p class="d-flex flex-wrap">
                  <span class="mr-4 footer-icon">
                    <i class="fas fa-phone"></i>
                  </span>
                  <span>+91 8978721605,  9441229786 , 8096951490</span>
                </p>
                <p class="d-flex flex-wrap">
                  <span class="mr-4 footer-icon">
                    <i class="fas fa-envelope"></i>
                  </span>
                  <span>aizzacet@yahoo.com</span>
                </p>
              </div>
            </Col>
            <Col
        ...
        <Container>
          <Row>
            <Col md={8} sm={6} xs={12}>
              ...
              Copyright © 2023 JNTUH Affiliations &
Academic Audit All rights reserved
